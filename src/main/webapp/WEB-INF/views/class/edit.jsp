			...
			<div class="board_write_wrap">
                <div class="board_write">
                    <form>
                        ...
                        <dl class="title">
                            <dt>제목</dt>
                            <dd><input type="text" value="충주 다녀왔어요." placeholder="제목 입력"></dd>
                        </dl>
                        <dl class="date">
                            <dt>날짜</dt>
                            <dd><input type="text" value="2019.11.01" placeholder="날짜 입력"></dd>
                        </dl>
                        <dl class="writer">
                            <dt>글쓴이</dt>
                            <dd><input type="text" value="부원장" placeholder="글쓴이 입력"></dd>
                        </dl>
                        <dl>
                            <dt>내용</dt>
                            <dd><textarea placeholder="내용 입력">가나다 가나다 가나다라마</textarea></dd>
                        </dl>
                        <dl class="link">
                            <dt>참고링크</dt>
